#!/bin/sh
# Script outline and installation for Linux kernel build and rootfs creation.
...
mkdir -p rootfs
cd rootfs
mkdir -p bin dev etc home lib lib64 proc sys tmp usr/bin usr/lib usr/sbin var sbin root mnt
